...
// The actual font data is expected to be defined in font6x8.h
// If needed, you can move the full font definition here instead.
const uint8_t font6x8_ascii[128][6] = {
